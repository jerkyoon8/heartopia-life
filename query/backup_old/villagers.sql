...
-- 1. 블랑코 (Blanc)
INSERT IGNORE INTO villagers (id, name, sub_title, image_url, location, unlock_condition, map_x, map_y) VALUES (1, '블랑코 (Blanc)', '원예 멘토 & 상점 주인', '/images/npc/NPC_icon_블랑코.png', '원예 상점', '튜토리얼 진행', 1000, 800);
...
-- 2. 바냐 (Vanya)
INSERT IGNORE INTO villagers (id, name, sub_title, image_url, location, unlock_condition, map_x, map_y) VALUES (2, '바냐 (Vanya)', '낚시 멘토', '/images/npc/NPC_icon_바냐.png', '가든 스트리트', '튜토리얼 진행', 1200, 500);
